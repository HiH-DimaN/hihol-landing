const faqs = [
  ...
  },
  {
    ...
    a: 'Один — это сознательный выбор. Вы работаете напрямую с разработчиком: без «эффекта испорченного телефона», без накладных агентства, без смены менеджеров. Отсюда фикс цена, срок 1–3 недели и полная передача кода и документации. До AI 20 лет на позициях COO/CCO в дистрибуции и производстве — понимаю бизнес-задачи, а не только технологии. Для сложных интеграций подключаю проверенных субподрядчиков, всегда согласую.',
  },
  {

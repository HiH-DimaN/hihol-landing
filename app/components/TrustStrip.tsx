...
export default function TrustStrip() {
  return (
    <div className="mt-8 flex w-full max-w-2xl items-center gap-4 rounded-2xl border border-slate-800 bg-slate-900/60 p-4 backdrop-blur-sm">
      <img
        src="/dmitry.jpg"
        alt="Дмитрий Хихол"
        width={64}
        height={64}
        loading="lazy"
        className="h-16 w-16 shrink-0 rounded-full object-cover ring-2 ring-cyan-400/40"
      />

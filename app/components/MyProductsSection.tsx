...
const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Skutr Docs',
    description:
      'Telegram-бот для генерации бизнес-документов из голоса, текста или фото. Счёт, акт, КП, договор — готовый PDF за 10 секунд. Для самозанятых и микробизнеса. Не бухгалтерия — только документы.',
  ...
  },
  {
    ...
    name: 'НейроЭксперт',
    description:
      'SaaS-платформа, превращающая экспертизу в клиентов из поиска и нейросетей. Эксперт наговаривает ответ голосом 10 минут — получает контент в 5 форматах, SEO-оптимизированный под ChatGPT и Яндекс.',
    stage: 'В разработке',
    links: [
      {
        label: 'Узнать больше',
